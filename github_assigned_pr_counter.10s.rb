...
ACCESS_TOKEN = 'your github access token' # Generate new token here https://github.com/settings/tokens (you must check [repo] to access to private repos)
REPO = 'owner/repo'
